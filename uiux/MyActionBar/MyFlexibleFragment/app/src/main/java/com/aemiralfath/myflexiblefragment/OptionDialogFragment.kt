...
import com.aemiralfath.myflexiblefragment.databinding.FragmentOptionDialogBinding
...
class OptionDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentOptionDialogBinding.bind(view)

        binding.btnChoose.setOnClickListener{
            val checkedRadioButtonId = binding.rgOptions.checkedRadioButtonId
            if (checkedRadioButtonId != -1) {
                val coach = when (checkedRadioButtonId) {
