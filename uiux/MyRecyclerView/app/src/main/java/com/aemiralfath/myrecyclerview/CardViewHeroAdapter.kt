...
import com.aemiralfath.myrecyclerview.databinding.ItemCardviewHeroBinding
        ...
        fun bind(hero: Hero) {
            with(binding) {
                Glide.with(itemView.context)
                    ...
                    .into(imgItemCardPhoto)

                tvItemCardName.text = hero.name
                tvItemCardDetail.text = hero.detail
